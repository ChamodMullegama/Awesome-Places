...
import 'package:layoutapp/pages/bookings_page/user_from.dart';
import 'package:layoutapp/utils/colors.dart';
import 'package:layoutapp/widgets/reuserble/bookinsg_page/Vehical_Card.dart';
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const CustomButton(text: "Submit", bgColor: mainNightlife),
              const SizedBox(
                height: 10,
              ),
            ],
